...
function AllList_Inventory({branch, userData}){
    ...
    useEffect(() => {
        ...
        axios.post(localStorage.getItem('urlLink')+'getInventoryListByTypeInventory.php', formData)
            .then(response => {
    ...
    ): (<div class="inventoryList-empty"> <label>EMPTY</label> <p>- EXAMINATION LIST -</p> </div>)}
