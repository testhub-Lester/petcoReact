...
function ModalEditItem_Inventory({closeModal, branch, userData, identifier, itemID, itemImage, itemName, itemType, itemPrice, itemQuantity}) {
    ...
    const itemUpdate = () => {
        ...
        axios.post('http://localhost/backend/Inventory_updateAdd.php', formData)
            .then(response => {
                console.log(response.data);
            })
            .catch(error => {
